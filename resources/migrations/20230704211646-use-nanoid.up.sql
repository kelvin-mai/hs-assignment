...
--;; setting default size at 16 instead of 21
...
--;;
CREATE OR REPLACE FUNCTION nanoid(size int DEFAULT 16, alphabet text DEFAULT '_-0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ')
    RETURNS text
    LANGUAGE plpgsql
    volatile
AS
